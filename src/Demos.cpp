...
std::shared_ptr<Model> makeDemo1() {
  ...
  auto rot_left = std::make_shared<Rotate>("rotate down", -4.0, grad_left);
  auto rot_right = std::make_shared<Rotate>("rotate up", 1.0, grad_right);
  ...
  auto rot_window = std::make_shared<Rotate>("rotate window", -0.5, window);
...
std::shared_ptr<Model> makeDemo2() {
  ...
  auto rot_grad = std::make_shared<Rotate>("Rotate Gradient", 2.0, gradient);
